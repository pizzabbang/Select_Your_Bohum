...
<script>
	function register() { //회원가입 클릭시
		location.href="register.mem"; //MemberRegisterController로 이동
	}
...
<center>
    <span class="border border-primary"><h2>select your 보험</h2></span>
<br><br><br>
...
<span class="border-end border-start" onclick="location.href='companyLogin.mem';">&nbsp;&nbsp;보험사 로그인&nbsp;&nbsp;</span>
