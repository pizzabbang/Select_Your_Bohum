...
<div class="container" style="align-content: center; margin: auto;">
		<h2 align="center">회원정보 탈퇴</h2>

<form:form class="form-horizontal" commandName="member" method="post" action="memberDeleteForm.mem" onSubmit="return right()">
